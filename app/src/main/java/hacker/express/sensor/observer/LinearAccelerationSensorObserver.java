...
public interface LinearAccelerationSensorObserver {
     ...
     *
     * @param linearAcceleration acceleration the acceleration values (x, y, z)
     * @param timeStamp          the time of the sensor update.
     */
    public void onLinearAccelerationSensorChanged(float[] linearAcceleration, float[] gyroscopeOrientation,
                                                  long timeStamp);
}
